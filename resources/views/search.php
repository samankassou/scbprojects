            ...
            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-3 col logo_section">
              <div class="full">
                <div class="center-desk">
                  <div class="logo">
                    <a href="index.php"><img src="images/4.png" alt="#" /></a>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="limit-box">
                  <nav class="main-menu ">
                    <ul class="menu-area-main">
                     ...
                     <li> <a href="login.php"><img src="icon/logos.png" alt="login.php" /></a></li>
                     </ul>
                   </nav>
                 </div>
               </div> 
                ...
                <div class="row">
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <div class="text-bg">
                          ...
                          <input class="Vegetable_fom" placeholder="Saisir la Référence du Projets" type="text" name=" Recherche">
