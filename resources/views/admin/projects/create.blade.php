            ...
            <form action="{{ route('admin.projects.store') }}" method="POST">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <input id="sponsor" type="text" name="sponsor" value="{{ old('sponsor') }}"
                        ...
                        <div class="form-group">
                            <select id="natures"
                                ...
                                <option value="{{ $nature->id }}"
                                    {{ collect(old('natures'))->contains($nature->id) ? "selected": "" }}>
                                    {{ $nature->name }}</option>
                                @endforeach
                            </select>
                            @error('natures')
                        ...
                        <div class="form-group">
                            <select id="steps" class="form-select multiple-remove @error('steps') is-invalid @enderror"
                                multiple name="steps[]">
                                @foreach ($steps as $step)
                                <option value="{{ $step->id }}"
                                    {{ collect(old('steps'))->contains($step->id) ? "selected": "" }}>{{ $step->name }}
                                </option>
                                @endforeach
                            </select>
                            @error('steps')
                        ...
                        <div class="form-group">
                            <select id="initiative" class="form-select @error('initiative') is-invalid @enderror"
                                name="initiative">
                                <option value="local" {{ old('initiative') == "local" ? "selected" : "" }}>local
                                </option>
                                <option value="groupe" {{ old('initiatie') == "groupe" ? "selected" : "" }}>groupe
                                </option>
                            </select>
                            @error('initiative')
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            <input id="amoa" type="text" name="amoa" value="{{ old('amoa') }}"
                        ...
                        <div class="form-group">
                            <input id="amoa" type="number" name="progress" value="{{ old('progress') }}"
                        ...
                        <div class="form-group">
                            <input id="moe" type="text" name="moe" value="{{ old('moe') }}"
                        ...
                        <div class="form-group">
                            <input id="manager" type="text" name="manager" value="{{ old('manager') }}"
                        ...
                        <div class="form-group">
                            <select id="status" class="form-select @error('status') is-invalid @enderror" name="status">
                                ...
                                <option value="inachevé" {{ old('status') == "inachevé" ? "selected" : "" }}>inachevé
                                </option>
                                <option value="en stand-by" {{ old('status') == "en stand-by" ? "selected" : "" }}>en
                                    stand-by</option>
                        ...
                        <div class="form-group">
                            <textarea id="documentation" name="documentation"
                                ...
                                rows="3">{{ old('documentation') }}</textarea>
                            @error('documentation')
                            <div class="invalid-feedback">
                                <i class="bx bx-radio-circle"></i>
                                {{ $message }}
