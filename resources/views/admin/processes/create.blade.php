                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <select id="domain" class="form-select @error('domain') is-invalid @enderror" name="domain">
                                ...
                                <option value="{{ $domain->id }}" {{ old('domain') == $domain->id ? "selected" : "" }}>
                                    {{ $domain->name }}</option>
                                @endforeach
                            </select>
                            @error('domain')
                        ...
                        <div class="form-group">
                            <select id="macroprocess" data-selected="{{ old('macroprocess') }}"
                                class="form-select @error('macroprocess') is-invalid @enderror" name="macroprocess">
                        ...
                        <div class="form-group">
                            <select id="method" data-selected="{{ old('method') }}"
                                class="form-select @error('method') is-invalid @enderror" name="method">
                        ...
                        <div class="form-group">
                            <select id="entities" class="form-select @error('entities') is-invalid @enderror" multiple
                                ...
                                <option value="{{ $entity->id }}"
                                    {{ collect(old('entities'))->contains($entity->id) ? "selected": "" }}>
                                    {{ $entity->name }}</option>
                                @endforeach
                            </select>
                            @error('entities')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input id="creation_date" type="date" value="{{ old('creation_date') }}"
                                        name="creation_date"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input id="created_by" type="text" value="{{ old('created_by') }}" name="created_by"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input id="written_date" type="date" value="{{ old('written_date') }}"
                                        name="written_date"
                                        class="form-control @error('written_date') is-invalid @enderror">
                                    @error('written_date')
                                    <div class="invalid-feedback">
                                        <i class="bx bx-radio-circle"></i>
                                        {{ $message }}
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input id="written_by" type="text" value="{{ old('written_by') }}" name="written_by"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input id="verification_date" type="date" value="{{ old('verification_date') }}"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input id="date_of_approval" type="date" value="{{ old('date_of_approval') }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input id="approved_by" type="text" value="{{ old('approved_by') }}"
                                        name="approved_by"
                        ...
                        <div class="form-group">
                            <input id="broadcasting_date" type="date" value="{{ old('broadcasting_date') }}"
                        ...
                        <div class="form-group">
                            <select id="status" class="form-select @error('status') is-invalid @enderror" name="status">
                                <option value="En cours de rédaction"
                                    {{ old('status') == "En cours de rédaction" ? "selected" : "" }}>En cours de
                                    rédaction</option>
                                <option value="En cours de vérification"
                                    {{ old('status') == "En cours de vérification" ? "selected" : "" }}>En cours de
                                    vérification</option>
                                <option value="En cours d'approbation"
                                    {{ old('status') == "En cours d'approbation" ? "selected" : "" }}>En cours
                                    d'approbation</option>
                                <option value="Existant" {{ old('status') == "Existant" ? "selected" : "" }}>Existant
                                </option>
                                <option value="A Créer" {{ old('status') == "A Créer" ? "selected" : "" }}>A Créer
                                </option>
                        ...
                        <div class="form-group">
                            <textarea id="modifications" name="modifications"
                                class="form-control @error('modifications') is-invalid @enderror" rows="3"></textarea>
                            @error('modifications')
                            <div class="invalid-feedback">
                                <i class="bx bx-radio-circle"></i>
                                {{ $message }}
                        ...
                        <div class="form-group">
                            <textarea id="appendices" name="appendices"
                                class="form-control @error('appendices') is-invalid @enderror" rows="3"></textarea>
                            @error('appendices')
                            <div class="invalid-feedback">
                                <i class="bx bx-radio-circle"></i>
                                {{ $message }}
