...
<body>
    ...
    <div class="my-5 page" size="A4">
        <div class="p-5">
            <section class="top-content bb d-flex justify-content-between">
                <div class="logo">
                    ...
                    <div class="graphic-path">
                             <div id="company">
                                <div class="arrow back"><div class="inner-arrow"><strong>No.Ref:&nbsp; {{ $process->reference }} </strong></div></div>
            ...
            <section class="top-content bb d-flex justify-content-between">
                <div class="top-left">
                    <h4><strong>Procédure:</strong></h4>&nbsp;&nbsp;&nbsp;&nbsp;<h2 style="text-align: center; text-decoration: underline;">{{ $process->name }}</h2>
                </div>
            </section>
            <section class="store-user mt-5">
                <div class="col-10">
                    ...
                    <div class="row extra-info pt-3">
                        <p class="m-0 font-weight-bold"><strong>Annexe(s):</strong> <p>{{ $process->appendices }}</p></p>
