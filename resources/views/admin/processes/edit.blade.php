        ...
        <div class="card-body">
            <form id="edit-form" data-process="{{ $process }}" data-old-method="{{ old('method') }}"
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <p><em>Les champs marqués d'un</em> (<span class="text-danger">*</span>) <em>sont
                                obligatoires</em></p>

                        <label for="edit-type">Type de modification:<sup class="text-danger">*</sup></label>
                        <div class="form-group">
                            <select id="edit-type" class="form-select @error('edit-type') is-invalid @enderror"
                                name="edit-type">
                                <option value="edit" @if(old('edit-type')=="edit" ) selected @endif>Correction</option>
                                <option value="update" @if(old('edit-type')=="update" ) selected @endif>Mise à jour
                                </option>
                            </select>
                            @error('edit-type')
                        ...
                        <label for="domain">Domaine:<sup class="text-danger">*</sup></label>
                        <div class="form-group">
