  ...
  <head>
    ...
    <!-- Custom Style -->
    <link rel="stylesheet" href="css/bootstrap-4.0.0/style.css">
            ...
            <section class="top-content bb d-flex justify-content-between">
                ...
                <div class="top-left">
                    ...
                    <div class="position-relative">
                        <p><span>XXXXXXXXXX</span></p>
                    </div>
                </div>
            </section>
            <section class="top-content bb d-flex justify-content-between">
                <div class="top-left">
                    <h4><strong>Non du Projet:</strong></h4><h2> &nbsp;&nbsp;&nbsp;&nbsp; Nom du Projet</h2>
                </div>
            </section>
            <section class="store-user mt-5">
                <div class="col-10">
                    <div class="row bb pb-3">
                            <p><strong> Date Début - Fin: </strong><span>10-04.2021 - 10-04.2021</span></p>
                    </div>
                    <div class="row extra-info pt-3">
                            ...
                            <p>Le Lorem Ipsum est simplement du faux texte employé dans
                               ...
                               1960 grâce à la vente de feuilles Letraset contenant des passages 
